...
<!-- phar -->
[Download the PHAR archive](https://github.com/osteel/dime/releases/download/v0.3/dime) from the [latest release](https://github.com/osteel/dime/releases/tag/v0.3).
<!-- /phar -->
