...
use Domain\Aggregates\SharePoolingAsset\ValueObjects\Exceptions\QuantityBreakdownException;
...
final class QuantityBreakdown implements SerializablePayload
{
    ...
    public function hasQuantityMatchedWith(SharePoolingAssetAcquisition $acquisition): bool
    {
        return $this->quantityMatchedWith($acquisition)->isGreaterThan('0');
    }

    /** @throws QuantityBreakdownException */
    public function quantityMatchedWith(SharePoolingAssetAcquisition $acquisition): Quantity
    {
    ...
    /** @throws QuantityBreakdownException */
    public function assignQuantity(Quantity $quantity, SharePoolingAssetAcquisition $acquisition): self
    {
