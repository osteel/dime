...
use App\Services\ObjectHydration\Repositories\CasterRepository;
use App\Services\ObjectHydration\Repositories\SerializerRepository;
use EventSauce\ObjectHydrator\ClassHydrationDefinition;
use EventSauce\ObjectHydrator\ClassSerializationDefinition;
...
use EventSauce\ObjectHydrator\PropertySerializationDefinition;
...
final class DefinitionProvider
{
    ...
    private CasterRepository $defaultCasters;

    private KeyFormatter $keyFormatter;

    private SerializerRepository $defaultSerializers;

    private PropertyTypeResolver $propertyTypeResolver;

    public function __construct(
        ?CasterRepository $defaultCasterRepository = null,
        ?KeyFormatter $keyFormatter = null,
        ?SerializerRepository $defaultSerializerRepository = null,
        ?PropertyTypeResolver $propertyTypeResolver = null,
    ) {
        $this->defaultCasters = $defaultCasterRepository ?? new CasterRepository([]);
        $this->keyFormatter = $keyFormatter ?? new KeyFormatterForSnakeCasing();
        $this->defaultSerializers = $defaultSerializerRepository ?? new SerializerRepository([]);
