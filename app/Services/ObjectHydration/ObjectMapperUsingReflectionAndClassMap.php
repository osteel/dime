...
class ObjectMapperUsingReflectionAndClassMap implements ObjectMapper
{
    ...
    /** @param array<class-string,class-string<PropertyCaster&PropertySerializer>> $classToHydratorTypeMap */
    public function __construct(
        private array $classToHydratorTypeMap
    ) {
        $this->definitionProvider = new DefinitionProvider(
            defaultCasterRepository: new CasterRepository($classToHydratorTypeMap),
            defaultSerializerRepository: new SerializerRepository($classToHydratorTypeMap),
        );
    }
